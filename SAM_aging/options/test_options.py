...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--exp_dir', default='./experiments',type=str,
                                 help='./experiments')
        self.parser.add_argument('--checkpoint_path', default='./checkpoints/sam_ffhq_aging.pt', type=str,
                                 help='./checkpoints')
        self.parser.add_argument('--data_path', type=str, default='./datasets/Color/',
        ...
        # arguments for aging
        self.parser.add_argument('--target_age', type=str, default='10,20,30,50,60,70',
